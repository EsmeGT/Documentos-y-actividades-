...
} else {$("#ardoraQuest").html(vHtml+"<img id='playSound' class='imaLeft' src='conceptos_de_quimica_resources/media/sound.png' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
